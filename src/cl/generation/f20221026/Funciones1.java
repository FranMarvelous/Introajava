...
public class Funciones1 {
	...
	public static void main(String[] args) {
		...
		//swagger = heramienta para documentar
		llamadaAOtroMetodo();
	}
...
//definicion o escritura de un método
	...
	// variable publica estática(no instanciada) TIPODATO nombredato (TIPODATO
	// nombrevar, TIPODATO nombrevar,TIPODATO nombrevar)
	/**
	 * METODO QUE UNE TODOS LOS DATOS!
	 *javadoc=comentar el orden del parametro
	 * @param nombre
	 * @param apePaterno
	 * @param apeMaterno
	...
	public static void llamadaAOtroMetodo() {
		...
		metodo4(1234,54.3f); //para que funcione debo llamarla en el main
